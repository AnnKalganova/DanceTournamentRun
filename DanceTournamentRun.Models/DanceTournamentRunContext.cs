...
{
    public partial class DanceTournamentRunContext : DbContext
    {
        public DanceTournamentRunContext()
        {
        }

        public DanceTournamentRunContext(DbContextOptions<DanceTournamentRunContext> options)
            : base(options)
        {
        }
